...
object AppointmentReadSide {
  ...
  val createReadSideShardId: String => String = ReadSideSharding.readSideFromPersistenceId(readShardName, readNumberOfShards)
  val readShards: immutable.Seq[String] = ReadSideSharding.readSideTags(readShardName, readNumberOfShards)
}
...
object ReadSideSharding {
  /**
    ...
    */
  def readSideFromPersistenceId(baseTag: String, numberOfShards: Int): String => String =
    persistenceId => createShardName(baseTag, abs(persistenceId.hashCode % numberOfShards))
  ...
  /**
    ...
    */
  def readSideTags(baseTag: String, numberOfShards: Int): immutable.Seq[String] = {
